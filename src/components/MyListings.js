...
const MyListings = () => {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        const response = await axios.get('http://35.202.159.88:3000/my-listings', {
  ...
  const handleDeleteListing = async (listingId, title) => {
    try {
      const response = await axios.delete('http://35.202.159.88:3000/delete-listing', {
  ...
  const handleSellItem = async (listingId, title, minBidValue) => {
    try {
      const response = await axios.post('http://35.202.159.88:3000/sell-item', {
