    ...
    try {
      if (file) {
        ...
        reader.onloadend = async () => {
          ...
          const response = await axios.post('http://35.202.159.88:3000/new-listing', JSON.stringify(jsonDataCopy), {
            headers: {
        ...
        // Send listing to backend
        const response = await axios.post('http://35.202.159.88:3000/new-listing', jsonData, {
          headers: {
            'Content-Type': 'application/json',
          },
        });
